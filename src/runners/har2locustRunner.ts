...
export class Har2LocustRunner {
  ...
  async convertHar(): Promise<void> {
    ...
    const applyOptions = await vscode.window.showQuickPick(
      [
        {
          label: 'No options (recommended)',
          description: 'Just convert',
          picked: true,
          id: 'none',
        },
        {
          label: 'Set template path…',
          description: 'har2locust --template <path>',
          id: 'template',
        },
        { label: 'Plugins…', description: 'har2locust --plugins <pkg1,script2.py>', id: 'plugins' },
        {
          label: 'Disable default plugins…',
          description: 'har2locust --disable-plugins <comma,list>',
          id: 'disable',
        },
        {
          label: 'Resource types…',
          description: 'har2locust --resource-types <xhr,document,...>',
          id: 'res',
        },
